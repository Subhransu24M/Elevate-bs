  ...
  return (
    <>
          <div className='container'>
            ...
            <div className='cntr-out-layout-1'>
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='col-md-12 col-lg-5 col-sm-12 col-xl-5'>
                            <CorporateForm/>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='row'>
                        <div className='col-md-12 col-lg-12 col-sm-12 col-xl-12'>
                            <div className='cfo-top-main-box'>
                                ...
                                <div>
                                    <p>Even small organizations, including startups, require effective financial management. However, these companies often lack the resources to hire a fully qualified CFO, leading the primary owner to assume CFO duties alongside CEO responsibilities and other functions. Eventually, the owner/CEO may find that financial management consumes too much time, detracting from core business duties. To address this, many businesses now opt for Outsourced CFO services.
                                        Numerous financial service organizations have embraced the idea of outsourcing CFO services and offering such solutions to their clients.
                                    </p>
                                    <p>
                        ...
                        <div className='col-md-12 col-lg-7 col-xl-7 col-sm-12'>
                            <ul className='cfo-ul'>
                                <li><FaLongArrowAltRight className='long-arrow' />You don’t pay Salary to a high profiled financial person as your CFO. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />You pay to a team -a company, that team works for you as CFO. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />No fear when anyone is leaving the job from the team- from the outsourced company.</li>
                                <li><FaLongArrowAltRight className='long-arrow' />A team serves you, so the collective experience is more effective than a individual’s expertise. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />A team from Auditing and Outsourced Accounting Industry is with Elevate, having a thorough knowledge of diverse business of UAE. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Financial Reporting, Financial Forecasting, Risk Management & Compliance , Cost Optimization  & all financial  strategic decisions are our daily job to many sizable companies in UAE </li>
                                <li><FaLongArrowAltRight className='long-arrow' />We @ Elevate Accounting & Auditing are CFO for many global headquarter business in UAE.</li>
                                <li><FaLongArrowAltRight className='long-arrow' />We Majorly hire Chartered Accountants, CPA & MBA in Finance & as a team and spend descent amount to get our people trained then we deliver Outsource CFO  Services from Elevate Accounting & Auditing </li>
                            </ul>
                        </div>
            ...
            <div className='cntr-out-layout-3'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-12 col-lg-12 col-sm-12 col-xl-12'>
                            <h2>Choose Elevate for CFO Services in UAE:</h2>
                        ...
                        <div className='col-md-12 col-lg-6 col-xl-6 col-sm-12'>
                            <ul className='cfo-ul'>
                                <li><FaLongArrowAltRight className='long-arrow' />Framing business strategies and action plans. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Accelerating the implementation of strategies. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Preparing annual budgets and fostering performance management discipline.</li>
                                <li><FaLongArrowAltRight className='long-arrow' />Generating management information system (MIS) reports tailored to decision-making requirements. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Establishing and implementing effective cash flow policies. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Setting up internal control procedures to enhance departmental efficiency and productivity. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Creating budgetary control measures.</li>
                                <li><FaLongArrowAltRight className='long-arrow' />Enhancing financial discipline in working capital management. </li>

                            </ul>
                        </div>
                        <div className='col-md-12 col-lg-6 col-xl-6 col-sm-12'>
                            <ul className='cfo-ul'>
                                <li><FaLongArrowAltRight className='long-arrow' />Offering professional guidance for business planning and forecasting. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Reviewing contracts and negotiating beneficial terms and conditions. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Budget preparation and monitoring. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Training and supporting accounting staff. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Handling insurance revisions and mitigating the risk of unexpected losses. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Collaborating and negotiating with bankers, attorneys, and business associates. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Enhancing debt collection and proper cash flow management. </li>
                                <li><FaLongArrowAltRight className='long-arrow' />Hiring right External Auditor. </li>
                            </ul>
                        </div>
                    </div>
                </div>
