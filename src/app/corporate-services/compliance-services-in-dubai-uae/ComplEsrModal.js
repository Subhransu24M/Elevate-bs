...
const ComplEsrModal = () => {
  return (
    <>
    <button type="button" class="btn btn-primary compl-btn" data-bs-toggle="modal" data-bs-target="#exampleModal33">
                Read More
            </button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title compl-btn-tlt" id="exampleModalLabel">Economic Substance Reporting(ESR)-  </h5>
