  ...
  return (
    ...
    <div className="mdl-east-des-sec1">
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 col-lg-6 col-xl-6 col-sm-12 col-xs-12">
                            ...
                            <div className="md-east-sec1-ctablk">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12 col-lg-12 col-xl-12 col-sm-12 col-xs-12">
                                <h2 className="mdl-east-sec2-hd">What is Middle East Desk Services in UK?</h2>
            ...
            <div className="mdl-east-des-sec3">
                        <div className="mdl-east-des-sec3-left">
                            <h2 className="mdl-east-sec3-hd">Choose Elevate as your Middle East Consultant in UK,London</h2>
                        ...
                        <div className="mdl-east-des-sec3-right">
                            <div className="mdl-east-des-sec3-right-cta">
                            <CorporateForm/>
                            </div>
                        </div>
