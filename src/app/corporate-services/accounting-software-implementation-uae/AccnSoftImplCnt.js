                                ...
                                <div className="row">
                                    <div className="col-md-12 col-lg-6 col-xl-6 col-sm-12 col-xs-12">
                                        <div className="acnt-impl-sec2-rght">
                                            ...
                                            <div className="acnt-impl-sec2-rght-btnblk"><AccountImplModal /></div>
                                        </div>
                                    </div>
                                    <div className="col-md-12 col-lg-6 col-xl-6 col-sm-12 col-xs-12">
                                        <div className="acnt-impl-sec2-rght">
                                            <h5>Mid-Size, Large, Family Offices</h5>
                                            <div className="acnt-impl-sec2-rght-btnblk"><AccountImplModal2 /></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 col-lg-8 col-xl-8 col-sm-12 col-xs-12">
                            <h2 className="acnt-impl-sec3-hd">Your Trusted Partner for Accounting System Implementation in the UAE</h2>
                            ...
                            <h2 className="acnt-impl-sec3-hd">Here's why you should choose Elevate:</h2>
