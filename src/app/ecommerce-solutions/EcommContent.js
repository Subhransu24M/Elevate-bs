...
import ecomimg from '../../../public/images/E-Commerce-Development.jpg';
...
const EcommContent = () => {
    return (
        <>
            <div className="ecommcnt-blk">
                <div className="container">
                    <h1>Top eCommerce Website Development Company London, UK</h1>
                    <div className="row">
            ...
            <div className="ecomm-snd-blk">
                <div className="container">
                    <h2>HELPING BUYERS & SELLERS TO ATTAIN THEIR GOALS</h2>
                    <div className="row">
                        ...
                        <div className="col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12">
                            <div className="ecomm-img-blk">
                                <Image src={ecomimg} alt="ecommerce development and solutions" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="e-comm-sec-4">
                <h2>Starting an online store but unsure how to begin? </h2>
                <div className="container">
                    <div className="row">
                    ...
                    <div className="e-comm-sec-4-sub-blk">
                        <h2>Our streamlined process for E-commerce Website Development</h2>
                        <div className="row">
        ...
        <h2>Elevating Your Sales with Enhanced E-commerce Functions</h2>
